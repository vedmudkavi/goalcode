...
export default function Home() {
  ...
  const fullSelectedPath = activeGoalPaths[selectedGoalStory.id];
  const selectedPath = [fullSelectedPath[0],fullSelectedPath[Math.max(1,fullSelectedPath.length-2)],fullSelectedPath[fullSelectedPath.length-1]];
  ...
  return <main className={`${isHullMatch?'hull-match ':''}${archiveActive?'archive-active':''}`}>
    ...
    <div className="page-shell">
      ...
      <section className="section-block simple-replay-section" id="replay">
        ...
        <div className="goal-replay-heading"><div><p className="kicker">GOAL JOURNEYS</p><h3>Pick a goal. Press play. Watch the ball hit the net.</h3></div><span>3 CLEAR STEPS PER GOAL</span></div>
